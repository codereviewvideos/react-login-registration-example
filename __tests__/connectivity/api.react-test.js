...
describe('Connectivity', () => {
  ...
  describe('login', () => {
    ...
    it('has a happy path', async () => {
      ...
      asyncFetch.fetchAsJson = jest.fn(() => { return {
        ok: true,
        json: () => 'worked'
      }});
    ...
    it('handles the unhappy path', async () => {
      ...
      async function doLogin() {
        return await api.login('baddy', 'badpass');
      }
  ...
  describe('fetchProfile', () => {
    ...
    it('handles the unhappy path', async () => {
      ...
      async function doFetchProfile() {
        return await api.fetchProfile(123);
      }
  ...
  describe('changePassword', () => {
    ...
    it('handles the unhappy path', async () => {
      ...
      async function doChangePassword() {
        return await api.changePassword(123, 'oldpass', 'newpass', 'newpass-mistake');
      }
